# Generated by Django 3.0.3 on 2020-08-01 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('des', models.CharField(default='No Description.', max_length=256)),
                ('date', models.DateTimeField(auto_now=True)),
                ('biddingclose', models.IntegerField(default=0)),
                ('currentBid', models.FloatField()),
                ('currentbiduser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bid', to=settings.AUTH_USER_MODEL)),
